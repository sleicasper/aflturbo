...
PROGS       = afl-gcc afl-fuzz afl-int afl-loc afl-hot afl-showmap afl-tmin afl-gotcpu afl-analyze
...
afl-int: afl-int.c $(COMM_HDR)
	$(CC) $(CFLAGS) $@.c -o $@ $(LDFLAGS)

afl-loc: afl-loc.c $(COMM_HDR)
	$(CC) $(CFLAGS) $@.c -o $@ $(LDFLAGS)

afl-hot: afl-hot.c $(COMM_HDR)
	$(CC) $(CFLAGS) $@.c -o $@ $(LDFLAGS)
...
clean:
	...
	rm -rf out_dir qemu_mode/qemu-2.10.0 *.dSYM
